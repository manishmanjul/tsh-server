...
public class ResponseMessage {
	...
	public final static ResponseMessage FAILED_TO_REGISTER = new ResponseMessage(904, "ERROR : Failed to register new User");
	public final static ResponseMessage SUCCESSFULLY_NEW_USER_ADDED= new ResponseMessage(SUCCESS, "Successfully Added a new User");
	public final static ResponseMessage INVALID_USERNAME_PASSWORD = new ResponseMessage(201, "Invalid User Name or Password");
	public final static ResponseMessage SESSION_EXPIRED = new ResponseMessage(401, "Session Expired. Please login again");
